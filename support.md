...
### What's the difference between the two streaks?
- 🔥 **Study streak** — counts every day you studied at all.
- 🎯 **Goal streak** — counts every day you met your daily goal.

Both allow a one-day grace (yesterday) so a single missed day doesn't reset you instantly. You can choose which one is shown as your headline streak in Settings.

### How do I set goals?
- **Daily goal** — a global target for total focus minutes per day (default 120). Set it in Settings or during onboarding.
- **Weekly goal per subject** — set an optional weekly minute target on each subject.

### Can I log study time I did away from the timer?
Yes. On the Insights tab, tap the **+** button to manually log a session — choose the subject, duration, date, and an optional note. Manual sessions count toward your totals, goals, and streaks just like timed ones.
...
Not currently. Your data lives on a single device. If your device is backed up via iCloud or a computer, app data may be included in that backup as part of the standard iOS backup process.

## Report a bug or request a feature

We'd love your feedback. Email **nico.frei@etik.com** with "Bug" or "Feature request" in the subject line and as much detail as you can. Bug reports that include your device model, iOS version, and steps to reproduce get fixed fastest.
